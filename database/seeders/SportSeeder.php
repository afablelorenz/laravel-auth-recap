    ...
    public function run(Faker $faker): void
    {
        $sports = [
            ...
            foreach ($sports as $sportName){
                ...
                $newSport -> is_individual = $faker->boolean();
                $newSport -> number_of_participants = $faker->numberBetween(1,50);
                $newSport -> save();
            }
            ...
            //$newSport -> is_individual = $faker->boolean(1,20);
            //$newSport -> number_of_participants = $faker->numberBetween();
            //$newSport -> save();
        //}
    }
}
